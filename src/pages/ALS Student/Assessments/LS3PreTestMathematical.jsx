...
export default function LS3PreTestMathematical() {
    ...
    const getSpecificStudents = async() =>{
        ...
        if(response.data[0].ls3_1 !== null){
            setAnswer1(response.data[0].ls3_1)
            setDisableAnswer1(true)
        }
        if(response.data[0].ls3_2 !== null){
            setAnswer2(response.data[0].ls3_2)
            setDisableAnswer2(true)
        }
        if(response.data[0].ls3_3 !== null){
            setAnswer3(response.data[0].ls3_3)
            setDisableAnswer3(true)
        }
        if(response.data[0].ls3_4 !== null){
            setAnswer4(response.data[0].ls3_4)
            setDisableAnswer4(true)
        }
        if(response.data[0].ls3_5 !== null){
            setAnswer5(response.data[0].ls3_5)
            setDisableAnswer5(true)
        }
        if(response.data[0].ls3_6 !== null){
            setAnswer6(response.data[0].ls3_6)
            setDisableAnswer6(true)
        }
        if(response.data[0].ls3_7 !== null){
            setAnswer7(response.data[0].ls3_7)
            setDisableAnswer7(true)
        }
        if(response.data[0].ls3_8 !== null){
            setAnswer8(response.data[0].ls3_8)
