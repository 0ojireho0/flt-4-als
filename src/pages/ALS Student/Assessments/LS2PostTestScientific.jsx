...
export default function LS2PostTestScientific() {
    ...
    const getSpecificStudents = async() =>{
        ...
        if(response.data[0].post_test_ls2_1 !== null){
            setAnswer1(response.data[0].post_test_ls2_1)
            setDisableAnswer1(true)
        }
        if(response.data[0].post_test_ls2_2 !== null){
            setAnswer2(response.data[0].post_test_ls2_2)
            setDisableAnswer2(true)
        }
        if(response.data[0].post_test_ls2_3 !== null){
            setAnswer3(response.data[0].post_test_ls2_3)
            setDisableAnswer3(true)
        }
        if(response.data[0].post_test_ls2_4 !== null){
            setAnswer4(response.data[0].post_test_ls2_4)
            setDisableAnswer4(true)
        }
        if(response.data[0].post_test_ls2_5 !== null){
            setAnswer5(response.data[0].post_test_ls2_5)
