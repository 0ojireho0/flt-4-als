...
export default function LS5PreTestUnderstanding() {
    ...
    const getSpecificStudents = async() =>{
        ...
        if(response.data[0].ls5_1 !== null){
            setAnswer1(response.data[0].ls5_1)
            setDisableAnswer1(true)
        }
        if(response.data[0].ls5_2 !== null){
            setAnswer2(response.data[0].ls5_2)
            setDisableAnswer2(true)
        }
        if(response.data[0].ls5_3 !== null){
            setAnswer3(response.data[0].ls5_3)
            setDisableAnswer3(true)
        }
        if(response.data[0].ls5_4 !== null){
            setAnswer4(response.data[0].ls5_4)
            setDisableAnswer4(true)
        }
        if(response.data[0].ls5_5 !== null){
            setAnswer5(response.data[0].ls5_5)
