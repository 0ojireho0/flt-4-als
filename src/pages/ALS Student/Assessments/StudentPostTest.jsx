...
export default function StudentPostTest() {
    ...
    const getSpecificStudents = async() =>{
      ...
      try {
        ...
        if(response.data[0].post_test_score_ls1_english == null){
          setGetScoreLS1English(0)
        }else{
          setGetScoreLS1English(response.data[0].post_test_score_ls1_english)
        }
        
        if(response.data[0].post_test_score_ls1_filipino == null){
          setGetScoreLS1Filipino(0)
        }else{
          setGetScoreLS1Filipino(response.data[0].post_test_score_ls1_filipino)
        }

        if(response.data[0].post_test_score_ls2_scientific == null){
          setGetScoreLS2(0)
        }else{
          setGetScoreLS2(response.data[0].post_test_score_ls2_scientific)
        }

        if(response.data[0].post_test_score_ls3_math == null){
          setGetScoreLS3(0)
        }else{
          setGetScoreLS3(response.data[0].post_test_score_ls3_math)
        }

        if(response.data[0].post_test_score_ls4_life == null){
          setGetScoreLS4(0)
        }else{
          setGetScoreLS4(response.data[0].post_test_score_ls4_life)
        }

        if(response.data[0].post_test_score_ls5_uts == null){
          setGetScoreLS5(0)
        }else{
          setGetScoreLS5(response.data[0].post_test_score_ls5_uts)
        }

        if(response.data[0].post_test_score_ls6_digital == null){
          setGetScoreLS6(0)
        }else{
          setGetScoreLS6(response.data[0].post_test_score_ls6_digital)
        }
  ...
  return (
    ...
    <div className="p-4 min-h-screen bg-gray-100">
      ...
      <div className="text-center mb-12">
        <h1 className="text-2xl font-bold mb-4">Post-Test (School Year 2022-2023)</h1>
      </div>
