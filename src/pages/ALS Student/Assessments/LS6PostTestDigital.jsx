...
export default function LS6PoostTestDigital() {
    ...
    const getSpecificStudents = async() =>{
        ...
        if(response.data[0].post_test_ls6_1 !== null){
            setAnswer1(response.data[0].post_test_ls6_1)
            setDisableAnswer1(true)
        }
        if(response.data[0].post_test_ls6_2 !== null){
            setAnswer2(response.data[0].post_test_ls6_2)
            setDisableAnswer2(true)
        }
        if(response.data[0].post_test_ls6_3 !== null){
            setAnswer3(response.data[0].post_test_ls6_3)
            setDisableAnswer3(true)
        }
        if(response.data[0].post_test_ls6_4 !== null){
            setAnswer4(response.data[0].post_test_ls6_4)
            setDisableAnswer4(true)
        }
        if(response.data[0].post_test_ls6_5 !== null){
            setAnswer5(response.data[0].post_test_ls6_5)
            setDisableAnswer5(true)
        }
        if(response.data[0].post_test_ls6_6 !== null){
            setAnswer6(response.data[0].post_test_ls6_6)
      ...
      const handleSubmitAnswers = async(e) =>{
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/getStudentAnswerDigitalPosttest',sendAnswer);
            console.log(response);
