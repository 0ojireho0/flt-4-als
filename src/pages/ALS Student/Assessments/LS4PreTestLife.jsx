...
export default function LS4PreTestLife() {
    ...
    const getSpecificStudents = async() =>{
        ...
        if(response.data[0].ls4_1 !== null){
            setAnswer1(response.data[0].ls4_1)
            setDisableAnswer1(true)
        }
        if(response.data[0].ls4_2 !== null){
            setAnswer2(response.data[0].ls4_2)
            setDisableAnswer2(true)
        }
        if(response.data[0].ls4_3 !== null){
            setAnswer3(response.data[0].ls4_3)
            setDisableAnswer3(true)
        }
        if(response.data[0].ls4_4 !== null){
            setAnswer4(response.data[0].ls4_4)
            setDisableAnswer4(true)
        }
        if(response.data[0].ls4_5 !== null){
            setAnswer5(response.data[0].ls4_5)
            setDisableAnswer5(true)
        }
        if(response.data[0].ls4_6 !== null){
            setAnswer6(response.data[0].ls4_6)
