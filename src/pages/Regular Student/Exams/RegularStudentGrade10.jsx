...
export default function RegularStudentGrade10() {
    ...
    const testData = [
        {
          ...
          link: '/regular-student/grade10-english'
        },
        {
          title: 'Filipino',
          score: `${getScoreFilipino}/3`,
          link: '/regular-student/grade10-filipino'

        },
        {
          title: 'Science',
          score: `${getScoreScience}/3`,
          link: '/regular-student/grade10-scientific'
        },
        {
          title: 'Math',
          score: `${getScoreMath}/3`,
          link: '/regular-student/grade10-math'
        },
  ...
  return (
    ...
    <div className="p-4  bg-gray-100">
      ...
      <div className="text-center mb-12">
        <h1 className="text-2xl font-bold mb-4">Periodical Exam for Grade 10</h1>
      </div>
